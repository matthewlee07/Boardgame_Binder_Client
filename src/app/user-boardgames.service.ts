...
export class UserBoardgamesService {
  ...
  editGame(user, gameID, numplayers, playingtime, rating) {
    ...
    return this.http.put<any>('https://boardgame-binder.herokuapp.com/userBoardgames' + { boardgameID: gameID }, {
  ...
  deleteGame(user, gameID) {
    ...
    return this.http.delete<any>('https://boardgame-binder.herokuapp.com/userBoardgames' + { boardgameID: gameID }, httpOptions);
  }
}
